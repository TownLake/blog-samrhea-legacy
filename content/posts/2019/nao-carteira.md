...
![Link to Card](../../../static/media/post-images/nao-carteira/link-to-card.png)

I punched in my Portuguese number and was then prompted to set a PIN code.

![Confirm PIN](../../../static/media/post-images/nao-carteira/confirm-pin.png)
...
![Validate Phone](../../../static/media/post-images/nao-carteira/validate-phone.png)
...
![Input PIN](../../../static/media/post-images/nao-carteira/input-pin.png)

And just like that, my card was now enrolled 

![MBWay Home](../../../static/media/post-images/nao-carteira/mbway-home.png)
...
![MBWay Valor](../../../static/media/post-images/nao-carteira/mbway-valor.png)
...
![Withdraw](../../../static/media/post-images/nao-carteira/withdraw-pin.png)
