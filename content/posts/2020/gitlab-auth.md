...
![](../../../static/media/post-images/gitlab/create.png)
...
![Install Gitlab](../../../static/media/post-images/gitlab/install.png)
...
![Services Only](../../../static/media/post-images/gitlab/just-services.png)
...
![GitLab Services](../../../static/media/post-images/gitlab/gitlab-services.png)
...
![GitLab Web](../../../static/media/post-images/gitlab/gitlab-web.png)
...
![GitLab SSH](../../../static/media/post-images/gitlab/gitlab-ssh.png)
...
![Tunnel Login](../../../static/media/post-images/gitlab/tunnel-login.png)
...
![Start cloudflared](../../../static/media/post-images/gitlab/cfd-start.png)
...
![](../../../static/media/post-images/gitlab/gitlab-web-start.png)

I'm going to create my first project, a repository to store a new Gatsby project that I am going to try to create.

![Gatsby Project](../../../static/media/post-images/gitlab/gatsby-project.png)
...
![Git Clone](../../../static/media/post-images/gitlab/git-clone.png)
...
![Disable Ingress](../../../static/media/post-images/gitlab/disable-ingress.png)
