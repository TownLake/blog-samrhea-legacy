...
socialImage: "./media/input-smb.png"
---
...
![Samba Service](./media/samba-service.png)
...
![cloudflared login](./media/cloudflared-login.png)
...
![service](./media/run-as-a-service.png)
...
![device settings](./media/device-settings.png)
...
![device settings](./media/enroll-rule.png)

Once saved, I can leave this page and configure my account's network settings.

![device settings](./media/enroll-summary.png)
...
![network settings](./media/network-settings.png)
...
![split tunnel](./media/enable-proxy-decrypt.png)
...
![input IP](./media/input-smb.png)

I'll authenticate with the credentials created earlier.

![smb login](./media/smb-login.png)
